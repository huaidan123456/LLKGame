...
{
public:
    static GameScene* createWithIconCount(int count);
    
    GameScene(int iconCount = 6);
    ~GameScene();
...
private:
    ...
    //** 电脑AI机制数组 *//
    std::vector<bool> _systemAIVector;
    int _systemIndex;
     ...
     *  更新AI操作
     */
    void updateGameSystemOperation(int addCount);
